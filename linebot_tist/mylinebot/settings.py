...
SECRET_KEY = 'django-insecure-roop9m1^tj^wg)$^d)c7z#8nncn7iy2x01fy6b(1s^90f=kdxi'
...
LINE_CHANNEL_SECRET = '62c41b4a365688bf8eb4d66ee9f1a6d4'
...
INSTALLED_APPS = [
    ...
    'biuanlinebot.apps.BiuanlinebotConfig',
]
